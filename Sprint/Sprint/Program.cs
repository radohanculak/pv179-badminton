...
using (var scope = _ioc.Container.BeginLifetimeScope())
{
    ...
    var userId = new Guid("57631c89-3294-4fd0-8571-56fc409fd067");
    var trainerId = new Guid("e173c3c2-8278-4790-96f3-72b9d055a0d2");
    var user2Id = new Guid("a610e319-b84f-43c7-879a-c982ef42c550");
    var courtId = new Guid("9f3d77f4-4151-4be2-ac2f-f8348a8a9e83");
    ...
    await trainerReviewService.AddReviewAsync(trainerReservation.Id, 9, "ano");

    var reviews = trainerReviewService.GetTrainerReviewsAsync(trainerId);
    var rating = trainerReviewService.GetRatingAsync(trainerId);
